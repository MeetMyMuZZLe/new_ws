...
def generate_launch_description():
    ...
    urdf_file = os.path.join(pkg_project, 'urdf', 'Robot_with_roller.urdf.xacro')
    ...
    doc1 = xacro.process_file(urdf_file, mappings={
        ...
        'roller_color': Robot1_roller_color,
    })
    ...
    doc2 = xacro.process_file(urdf_file, mappings={
        ...
        'roller_color': Robot2_roller_color,
    })
