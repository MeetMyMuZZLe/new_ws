...
def generate_launch_description():
    urdf_file = '/home/meet/ros2_ws/src/urdf_tutorial/urdf/manipulator.urdf'
    controller_file = '/home/meet/ros2_ws/src/urdf_tutorial/config/control.yaml'
    robot_description = {"robot_description": urdf_file}

    # Include Gazebo launch file
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource("/home/meet/ros2_ws/src/urdf_tutorial/launch/arm_gazebo.launch.py"),
    )
