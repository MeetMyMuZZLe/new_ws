...
class squarePathNode(Node):
    def __init__(self):
        ...
        self.square_points = [
            ...
            (-5.0, -5.0),    # Second vertex
            (0.0, -5.0),     # Third vertex
        ...
        self.get_logger().info("square Path Controller Started")
        
    def get_current_target(self):
        return self.square_points[self.current_target]
    
    def move_to_next_target(self):
        self.current_target = (self.current_target + 1) % len(self.square_points)
